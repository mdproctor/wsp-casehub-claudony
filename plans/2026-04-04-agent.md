...
import config.remotecc.server.model.CreateSessionRequest;
...
```java
package config.remotecc.agent.terminal;
...
class McpServerTest {
    ...
    @InjectMock
    config.remotecc.agent.terminal.TerminalAdapterFactory terminalFactory;
...
import config.remotecc.agent.terminal.TerminalAdapterFactory;
import config.remotecc.config.RemoteCCConfig;
import config.remotecc.server.model.CreateSessionRequest;
